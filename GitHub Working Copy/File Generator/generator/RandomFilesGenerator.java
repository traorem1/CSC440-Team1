...
/*
 ...
 For the fileGeneration.txt, I wasn't sure if it should contain file types (.txt, .docx, .html...) or actual names of files to be created
 so I opted for the second scenario until further explanation.
*/
...
public class RandomFilesGenerator {
    ...
    public void generateFiles() throws Exception {
      this.generateFiles(FOLDER + "fileGeneration.txt");
    }
       
    public void generateFiles(String fileGenerationName) throws Exception{
      try {
        ...
        createFiles(fileGenerationName);
        
        //Get the number of files from the file generation file
        ...
        System.out.println("The specified file (" + fileGenerationName + ")does not exist!");
        //return false;
      }
 ...
 */
 public void createFiles(String fileGenerationName) throws IOException {
   //Variables
   String line = null;
   int nbLines = 0;
